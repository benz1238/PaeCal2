...
const getMealOptions = () => {
    ...
    return [
      {
        title: "โจ๊กหมู + ไข่",
        tag: "อุ่นท้อง",
        desc: "อยู่ท้องกว่าแค่กาแฟ แปะว่าเริ่มวันดี",
        imageUrl: MEAL_IMAGE_URLS.soup,
      },
      {
        title: "โยเกิร์ต + กล้วย",
        tag: "เบา ๆ",
        desc: "รีบ ๆ ก็ยังพอมีทรง ไม่หนักเกิน",
        imageUrl: MEAL_IMAGE_URLS.yogurt,
      },
      {
        title: "ข้าวอกไก่ไข่ต้ม",
        tag: "โปรตีนมา",
        desc: "เช้าแบบตั้งใจ แต่ไม่ฝืนเกินไป",
        imageUrl: MEAL_IMAGE_URLS.chicken,
      },
    ];
  }
    ...
    return [
      {
        title: "ข้าวไก่ย่าง",
        tag: "อิ่มพอดี",
        desc: "โปรตีนมี แป้งมี ถ้าไม่ราดมันเยอะคือผ่าน",
        imageUrl: MEAL_IMAGE_URLS.chicken,
      },
      {
        title: "ข้าวกะเพราไข่ดาว",
        tag: "สายจริง",
        desc: "กินได้ แค่ลดน้ำมันนิดนึงก็พอ",
        imageUrl: MEAL_IMAGE_URLS.riceBowl,
      },
      {
        title: "สุกี้น้ำ",
        tag: "เบาแต่ครบ",
        desc: "ผักมา โปรตีนมา ทรงนี้ไม่ง่วงบ่าย",
        imageUrl: MEAL_IMAGE_URLS.noodle,
      },
    ];
  }
    ...
    return [
      {
        title: "ไข่ต้ม + ผลไม้",
        tag: "กันหลุด",
        desc: "รองท้องดี ไม่เปิดเกมใหญ่เกิน",
        imageUrl: MEAL_IMAGE_URLS.yogurt,
      },
      {
        title: "สลัดอกไก่",
        tag: "คลีนไม่เครียด",
        desc: "เอาไว้ตัดเกมบ่าย แปะว่าเวิร์ก",
        imageUrl: MEAL_IMAGE_URLS.salad,
      },
      {
        title: "ซุปใส / เกาเหลา",
        tag: "เบาอุ่น",
        desc: "อิ่มแบบไม่ลากยาวไปมื้อเย็น",
        imageUrl: MEAL_IMAGE_URLS.soup,
      },
    ];
  }
  ...
  if (hour >= 17 && hour < 21) {
    return [
      {
        title: "เกาเหลา + ข้าวนิด",
        tag: "เย็นพอดี",
        desc: "อิ่มอยู่ แต่ไม่แน่นเกิน แปะโอเค",
        imageUrl: MEAL_IMAGE_URLS.soup,
      },
      {
        title: "ข้าวปลา/ไก่ย่าง",
        tag: "คุมได้",
        desc: "โปรตีนดี เลี่ยงของทอดหน่อยคือสวย",
        imageUrl: MEAL_IMAGE_URLS.chicken,
      },
      {
        title: "สุกี้น้ำ",
        tag: "เซฟสุด",
        desc: "มื้อเย็นที่ไม่เล่นใหญ่ แต่ยังอิ่ม",
        imageUrl: MEAL_IMAGE_URLS.noodle,
      },
    ];
  }
  ...
  return [
    {
      title: "นมจืด / โยเกิร์ต",
      tag: "ดึกเบา ๆ",
      desc: "ถ้าหิวจริง เอาแค่นี้พอ ไม่ต้องเปิดครัวใหญ่",
      imageUrl: MEAL_IMAGE_URLS.yogurt,
    },
    {
      title: "ไข่ต้ม 1–2 ฟอง",
      tag: "โปรตีนเร็ว",
      desc: "ง่าย จบ ไม่ลากยาว แปะว่าโอเค",
      imageUrl: MEAL_IMAGE_URLS.chicken,
    },
    {
      title: "ซุปใสอุ่น ๆ",
      tag: "ท้องไม่โวย",
      desc: "ดึกแล้วเอาเบา ๆ ให้ท้องพักบ้าง",
      imageUrl: MEAL_IMAGE_URLS.soup,
    },
  ];
};
    ...
    contents: [
      ...
      },
      {
        ...
        contents: [
          {
            type: "text",
            text: "เลื่อนดูเมนูที่แปะแนะนำได้เลย 👉",
            size: "sm",
            weight: "bold",
            color: "#003C88",
            wrap: true,
...
export const buildMealSuggestionCarouselFlexMessage = () => {
  ...
  return {
    ...
    contents: {
      type: "carousel",
      contents: [buildIntroBubble(mood), ...meals.map(buildMealBubble)],
    },
  };
};
