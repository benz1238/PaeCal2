...
กฎสำคัญ:
1. ถ้าภาพไม่ใช่อาหาร ให้ตั้ง isFood=false, kcal=0, menuName="", และระบุ imageSubject เป็นสิ่งที่เห็นชัดที่สุด เช่น "แมว", "หมา", "คน", "เอกสาร", "จอคอม", "แก้วน้ำ", "วิว"
...
8. ห้ามบอกว่ามองไม่ชัด ถ้าในภาพเห็นชัดว่าเป็นสิ่งที่ไม่ใช่อาหาร ให้ระบุ imageSubject ไปเลย
...
`,
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "ดูภาพนี้ก่อนว่าเป็นอาหารไหม ถ้าไม่ใช่อาหารให้บอก imageSubject ว่าเป็นอะไร ถ้าเป็นอาหารให้ประเมิน kcal, carb, protein, fat เป็นตัวเลขหน่วยกรัม และตั้งชื่อเมนูให้ตรงภาพที่สุด",
          },
          {
            type: "image_url",
            image_url: {
