...
- ห้ามรวมชื่อรายการหลายอย่างเป็นชื่อกว้าง ๆ เช่น "เครื่องดื่มผลไม้" ถ้าผู้ใช้ระบุชื่อไว้แล้ว
...
`,
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "ดูภาพนี้ก่อนว่าเป็นอาหารหรือเครื่องดื่มที่คนกิน/ดื่มได้ไหม ถ้าเป็นเครื่องดื่ม เช่น โค้ก น้ำอัดลม ชานม กาแฟ โกโก้ ให้ถือว่าเป็นอาหารได้และประเมินแคล ถ้าไม่ใช่อาหาร/เครื่องดื่มให้บอก imageSubject ว่าเป็นอะไร และใส่ imageCaption เป็นคำบรรยายสั้น ๆ ว่าเห็นอะไร/กำลังทำอะไร ถ้าเป็นอาหาร/เครื่องดื่มให้ประเมิน kcal, carb, protein, fat เป็นตัวเลขหน่วยกรัม และตั้งชื่อเมนูให้ตรงภาพที่สุด",
          },
          {
            type: "image_url",
            image_url: {
